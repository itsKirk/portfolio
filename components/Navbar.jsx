...
function Navbar({ children }) {
  ...
  return (
    <>
      <div className="fixed w-full mx-auto h-[80px] flex z-[55]  justify-between items-center px-24 bg-[#0a192f] text-gray-300 mb-[50px]">
        ...
        <ul className="hidden md:flex absolute right-28">
          <Switch
            to="home"
            smooth={true}
            className="text-lg cursor-pointer font-normal space-x-4 mx-2 hover:text-[#7abe41]">
            Home
          </Switch>
          <Switch
            to="about"
        ...
        <ul
          ...
          <Switch
            ...
            smooth={true}
            onClick={handleMobileMenu}
            className="py-6 text-4xl font-bold  cursor-pointer hover:text-[#7abe41]">
            Home
          </Switch>
          <Switch
            to="about"
      ...
      <div className="hidden md:flex fixed flex-col justify-evenly left-0 top-[35%]">
        <ul>
          <Link
            ...
            target="_blank"
            className="flex justify-between items-center w-[100px] ml-[-65px] hover:ml-[0px] duration-500 cursor-pointer">
            <span className="font-bold text-white">LinkedIn</span>
            <FaLinkedinIn
              className="text-[#7abe41]"
              size={30}
            />
          </Link>
          <Link
            href="https://twitter.com/DrWambua"
            target="_blank"
            className="flex justify-between items-center w-[100px] ml-[-65px] hover:ml-[0px] duration-500 cursor-pointer">
          ...
          <Link
            ...
            target="_blank"
            className="flex justify-between items-center w-[120px] ml-[-85px] hover:ml-[0px] duration-500 cursor-pointer">
            <span className="font-bold text-white text-xs">Buy Me Coffee</span>
            <FaCoffee
              size={30}
              className="text-[#7abe41]"
            />
          ...
          <Link
            href="Patrick's CV.pdf"
            download="Patrick's CV.pdf"
            className="flex justify-between items-center w-[100px] ml-[-65px] hover:ml-[0px] duration-500 cursor-pointer">
      ...
      <div className="absolute top-24 mx-5">{children}</div>
    </>
  );
}
